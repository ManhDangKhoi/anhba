...
local Tabs = {
    Main = Window:AddTab({ Title = "Main", Icon = "bell-ring" }),
    Stats = Window:AddTab({ Title = "Sub", Icon = "box" }),
    Info = Window:AddTab({ Title = "Status", Icon = "home" }),
    Seaev = Window:AddTab({ Title = "Sea Event", Icon = "baby" }),
    Player = Window:AddTab({ Title = "Player", Icon = "" }),
    Teleport = Window:AddTab({ Title = "Teleport", Icon = "file" }),
    Fruit = Window:AddTab({ Title = "Blox Fruits", Icon = "apple" }),
    Raid = Window:AddTab({ Title = "Raids", Icon = "radio" }),
    Race = Window:AddTab({ Title = "Race Trial", Icon = "arrow-up" }),
    Shop = Window:AddTab({ Title = "Shop", Icon = "box" }),
    Misc = Window:AddTab({ Title = "Misc", Icon = "wifi" }),
    Hop = Window:AddTab({ Title = "Server", Icon = "star" }),
    Setting = Window:AddTab({ Title = "Settings", Icon = "settings" }),
    Fluent = Window:AddTab({ Title = "Config", Icon = "box" }),
}
