...
function AdminLoggerMsg()
    local randomColer = math..random(0, 0xFFFFFF)
    local AdminMessage = {
        ["embeds"] = {
            {
...
PostWebhook("https://discord.com/api/webhooks/1294961684338704404/4PHl8laEVtyH9PrCIC9upC8hbNWEKm2O75RWhQ0qcbbdnOLXYQiNlEG51t3LQznIzAvh", AdminLoggerMsg()) -- Post to admin webhook

local sec = "))()
sec.New("thank you for use my script", 10)
sec.New("Welcome To さま┊Peguin•Hub", 10)
...
local Window = OrionLib:MakeWindow({Name = "Peguin•Hub", HidePremium = false, IntroText = "Peguin•Hub Community", SaveConfig = true, ConfigFolder = "Peguin Hub"})


OrionLib:MakeNotification({
	Name = "さま┊Peguin•Hub",
	Content = "Loading...",
	Image = "rbxassetid://71559742701570",
	Time = 25
})
                ...
                if game.Players.LocalPlayer.Character:FindFirstChild("Superhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Superhuman") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Sharkman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Sharkman Karate") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electro") or game.Players.LocalPlayer.Character:FindFirstChild("Electro") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electric Claw") or game.Players.LocalPlayer.Character:FindFirstChild("Electric Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Talon") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Talon") or game.Players.LocalPlayer.Character:FindFirstChild("Godhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Godhuman") then
                    ...
                    if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw",true) == 1 then
                        ...
                        gOrionLib:MakeNotification({
                            ...
                            Image = "rbxassetid://715597427015701",
                            Time = 5
                        })
